...
class CloudRegistryClient:
    ...
    def __init__(self, registry_url: Optional[str] = None):
        ...
        """
        self.registry_url = registry_url or os.getenv("NEKO_CLOUD_REGISTRY_URL")
        if not self.registry_url:
            raise ValueError("未配置云端注册服务地址，请设置 NEKO_CLOUD_REGISTRY_URL 环境变量")
...
async def test_client():
    ...
    # 从环境变量读取或直接指定
    # os.environ["NEKO_CLOUD_REGISTRY_URL"] = "http://47.117.174.64:8000"
