...
from .tile_templates import classify_tile_from_templates, is_probably_occupied_hand_slot
...
def detect_drawn_tile_fast_path(
    ...
    *,
    ...
    with Image.open(image_path) as opened:
        ...
        match = classify_tile_from_templates(crop, calibration.hand_tile_templates)
        if match is None:
