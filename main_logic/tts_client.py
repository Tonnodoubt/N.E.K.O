...
def get_tts_worker(core_api_type='qwen', has_custom_voice=False, voice_id='', audio_format=None):
    """
    ...
    if has_custom_voice and voice_id:
        ...
        if voice_id not in set(get_free_voices().values()):
            if audio_format:
                return partial(cosyvoice_vc_tts_worker, audio_format=audio_format), None
